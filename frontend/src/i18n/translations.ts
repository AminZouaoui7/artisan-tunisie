  ...
  FR: {
    ...
    auth: {
      ...
      verifyEmail: {
        ...
        successMessage: "Email confirmé. Redirection vers la connexion…",
        resendHint: "Vous n’avez rien reçu ?",
        resendAction: "Renvoyer le code",
        resendLoading: "Envoi en cours…",
        resendSuccess: "Un nouveau code de confirmation a été envoyé.",
        ...
        errors: {
          ...
          resendUnknown: "Impossible de renvoyer le code pour le moment.",
  ...
  EN: {
    ...
    auth: {
      ...
      verifyEmail: {
        ...
        successMessage: "Email confirmed. Redirecting you to sign in…",
        resendHint: "Didn’t receive anything?",
        resendAction: "Resend code",
        resendLoading: "Sending…",
        resendSuccess: "A new confirmation code has been sent.",
        ...
        errors: {
          ...
          resendUnknown: "Unable to resend the code right now.",
